...
<div className='content'>
  <div className='left-content'>
    <h1 className='leftheader'>Testing <span className="bluecontent">Services</span></h1>
    <p className='leftcontent'>Maintain competitive and high-quality standards with NFC’s Quality Assurance and Testing services.</p>
    <button className='leftbtn'><a href="#" className='leftbtnlink'>Know More</a></button>
  </div>
</div>
  <div className='headerimgdiv'>
  <img className='headerimg' src={testing} alt=""/>

  </div>
      </header>
      <div className='individulasection'>
        <div className='paragraphs'>
        <p className='para-1'>As a part of software testing services, a developed project is deployed in the right testing environment, to check if the project outcomes are in sync with the client requirements. Other aspects of the software are also tested like, its functionality and performance. It is also tested for bugs or errors.</p>
        <p className='para-2'>
        We believe in enhancing the customer experience by delivering quality software that meets the specified business requirements. Our team of highly skilled and competent testing engineers make sure that their work eliminates all the glitches and discrepancies, thereby giving the end-user a seamless experience.
        </p>
