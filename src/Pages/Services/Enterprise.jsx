...
<div className='content'>
  <div className='left-content'>
    <h1 className='leftheader'>Enterprise Application<span className="bluecontent"> In JAVA, .NET & PHP</span></h1>
    <p className='leftcontent'>Automate, Optimize and Upgrade your complex business equations and turn them into an enterprise application of smooth implementation.</p>
    <button className='leftbtn'><a href="#" className='leftbtnlink'>Know More</a></button>
  </div>
</div>
  <div className='headerimgdiv'>
  <img className='headerimg' src={enterprise} alt=""/>

  </div>
      </header>
      <div className='individulasection'>
        <div className='paragraphs'>
        <p className='para-1'>Enterprise Application software is a critical component for any complex business ecosystem that has multiple channels of functionalities. EA software is an essential component of any computer information system. EA software ultimately improves efficiency and productivity through business-grade support features.</p>
        <p className='para-2'>
        At some point, your business grows so big that its smooth functioning and management become a very hefty task. In such cases, a high-tech software tool that is easy in its operation proves to be of great help in aligning business processes in your company. An enterprise application can be a great solution in this situation
        </p>
