...
<div className='content'>
  <div className='left-content'>
    <h1 className='leftheader'>Digital <span className="bluecontent">Marketing</span></h1>
    <p className='leftcontent'>Experience the evolved form of approaching and understanding consumer behaviour with marketing on various digital channels.</p>
    <button className='leftbtn'><a href="#" className='leftbtnlink'>Know More</a></button>
  </div>
</div>
  <div className='headerimgdiv'>
  <img className='headerimg' src={digital} alt=""/>

  </div>
      </header>
      <div className='individulasection'>
        <div className='paragraphs'>
        <p className='para-1'>As the world gets active on digital platforms, the ways of marketing also take a new turn. The traditional form of marketing doesn’t have much relevance now as Digital Marketing brings a new way of targeting and approaching the desired audience through platforms such as, websites, social media, emails and mobile app notifications.</p>
        <p className='para-2'>
        What gives digital marketing an edge over traditional marketing is that it makes the audience measurable, has a much wider reach, and the statistics show great insights. But in a world where all the brands are highly dependent on digital marketing, NFC Solutions assures assistance in penetrating a highly competitive market and in maintaining a unique brand image. </p>
