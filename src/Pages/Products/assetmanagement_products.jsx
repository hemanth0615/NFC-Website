...
import DesktopMobile from "../../images/products_mobile and desktop.png";
...
function ProductsBody1(body1){
    return(
        <>
            ...
            <div className="knowmorebutton"><button class="products_knowmore"><p className="knowmoretext">Know More</p></button></div> 
        </>
    );
    ...
    return(
        <div class="AssetmanagementProducts_body">
            ...
            <div class="AssetmanagementProducts_body1">
                <ProductsBody1 productimage={AssetmanagementImage} productname="ASSET MANAGEMENT" productdescription="A flexible asset management system to counter complex
business challenges." productdescription1="A seamless integration of simple asset tracking solution, user-friendly dashboards and a smart mobile application." src={DesktopMobile} />
            </div>
...
important aspects of the product." />
            ...
            <div className="products_individual_features_cards">
                <div className="products_individual_features_card1">
                    <ProductsBody3 featuresimage={one} productfeaturesname="Simple Asset Tracking Solution" productfeaturesnamedescription="Organize your assets on the basis of serial number, location, bar code etc, for an easy
management." />
                </div>
                <div className="products_individual_features_card2">
                    <ProductsBody3 featuresimage={two} productfeaturesname="A user-friendly Dashboard Page" productfeaturesnamedescription="Add different assets, group them and add their inventory details. View, edit or delete assets as per your requirement." />
                </div>
                <div className="products_individual_features_card3">
                    <ProductsBody3 featuresimage={three} productfeaturesname="INTA App" productfeaturesnamedescription="Smart and convenient way of adding assets, generating a QR code for an asset, printing a QR code, and searching an asset by just scanning a QR code.." />
                </div>
            </div>
...
export default AssetmanagementProducts