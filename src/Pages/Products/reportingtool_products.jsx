...
import "./reportingtool_products.css";
...
function ProductsBody1(body1){
    return(
        <>
            ...
            <div className="knowmorebutton repoB"><button class="products_knowmore"><p className="knowmoretext">Know More</p></button></div> 
        </>
    );
   ...
   return(
        <div class="AssetmanagementProducts_body">
            ...
            <div class="AssetmanagementProducts_body1">
                <ProductsBody1 productimage={ReportingTool} productname="Reporting Tool" productdescription="A simple, efficient, and automated warehouse management system" productdescription1="The ideal route-tracking and warehouse management solution for complex and multi-channel deliveries." />
            </div>
...
important aspects of the product." />
            ...
            <div className="products_individual_features_cards">
                <div className="products_individual_features_card1">
                    <ProductsBody3 featuresimage={one} productfeaturesname="Efficient Route Management" productfeaturesnamedescription="Designed with smart splitting work engine to distribute single source file to
multiple routes." />
                </div>
                <div className="products_individual_features_card2">
                    <ProductsBody3 featuresimage={two} productfeaturesname="Fully Automated Panel" productfeaturesnamedescription="Automatic file processing and email dispatching with an easy-to-use web
interface to reduce processing time." />
                </div>
                <div className="products_individual_features_card3">
                    <ProductsBody3 featuresimage={three} productfeaturesname="Easy User Management" productfeaturesnamedescription="Create and organize multiple users on the basis of specific warehouses, date,
time and user id." />
                </div>
            </div>
